...
import { BarChart, AlertTriangle, Package, ChevronDown, Paperclip, Mic, ArrowRight, Menu, X, Home, Settings, HelpCircle, LogOut, Zap, MessageCircle } from 'react-feather';
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#DEE2ED] to-white font-inter">
      ...
      <div className={`transition-all duration-500 ease-in-out ${sidebarOpen ? 'ml-80' : 'ml-32'}`}>
        ...
        {activeSection === 'analytics' && (
          <div className="pt-28 pl-2 pr-4 pb-8 animate-fade-in-up">
